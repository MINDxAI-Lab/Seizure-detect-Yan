...
ROOT_PATH="/home/y0chen55/seizure_detect/LLMsForTimeSeries/resampled_200hz_12s"
...
# # 6. 使用频域增强训练（Frequency Domain Augmentation）
# echo "=== 6. 频域增强训练（Frequency Domain Augmentation）==="
# python main_cls.py \
#     --model_id "${MODEL_ID}_freqdomain" \
#     --model PAttn \
#     --data eeg_seizure \
#     --root_path "$ROOT_PATH" \
#     --data_path "$DATA_PATH" \
...
#     --aug_freq \
#     --aug_freq_p 0.5 \
#     --aug_freq_num_segments 3 \
#     --aug_freq_segment_ratio_low 0.05 \
#     --aug_freq_segment_ratio_high 0.15 \
#     --save_file_name "freqdomain_results.txt"
