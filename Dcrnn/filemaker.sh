#!/bin/bash
#SBATCH --job-name=filemaker_TUSZ
...
echo "Start running"
python generate_file_markers_v2.py   --resampled_dir ./TUSZ_resampled \
  --raw_data_dir /home/y0chen55/seizure_detect/TUSZ/edf \
    --output_dir ./data/file_markers_detection   --clip_len 12
